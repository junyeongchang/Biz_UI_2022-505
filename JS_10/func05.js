...
// 2000년대 초반, 더글라스 코록포트 등에 의해
// JSON 데이터 구조가 제안된다.
// 이 데이터 구조 제안이 정말 혁명적이었다.
// 모든 데이터를 키(key)-값(value) 쌍으로 규정하고 매우 단순화 시켰다.
// 단순하된 구조는 당시까지 현존하던 거의 대부분의 프로그램언어ㅢ
// 기본 자료형으로 쉽게 변환이 가능했다.
// 네트워크를 통해서 데이터를 전송할때 데이터 양을 획기적으로 줄일 수 있었다.
